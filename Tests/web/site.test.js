...
test('W8 the wordmark is Backspacer (y) and the page explains the wink once', () => {
...
test('W10 the tagline is the one Pearl Jam nod: under the h1, in og:description, and nowhere else', () => {
