...
## Unreleased
- Standard menus: Edit gets Undo/Cut/Paste, Window gets Zoom and Bring All to Front, and a Help menu links to GitHub, the issue tracker and the diagnostics log.
